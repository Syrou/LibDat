...
var UInt32Data = /** @class */ (function (_super) {
    __extends(UInt32Data, _super);
    function UInt32Data(type, reader, options) {
        ...
        _this.Value = reader.ReadUInt32();
        _this.Length = type.Width;
        return _this;
    }
    UInt32Data.prototype.GetValueString = function () {
