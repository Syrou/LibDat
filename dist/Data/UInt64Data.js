...
var UInt64Data = /** @class */ (function (_super) {
    __extends(UInt64Data, _super);
    function UInt64Data(type, reader, options) {
        ...
        _this.Value = reader.ReadUInt64();
        _this.Length = type.Width;
        return _this;
    }
    UInt64Data.prototype.GetValueString = function () {
